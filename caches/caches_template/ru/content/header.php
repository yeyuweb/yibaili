...
<div class="head">
	...
	<li ><a href="<?php echo APP_PATH;?>ru" class="s04"><img src="<?php echo IMG_PATH;?>t44.jpg" width="28" height="17" /></a></li>
        ...
        <div class="p3">
            <select id="ddltype">
          <option value="59">Tipo de Produto</option>
          <option  value="60">A manchete</option>
      </select></div>
        <input type="hidden" name="m" value="search"/>
        <input type="hidden" name="c" value="index"/>
        <input type="hidden" name="a" value="init"/>
        <input type="hidden" name="typeid" value="59" id="typeid"/> 
    ...
    <div class="mainNav clearfix">   
        ...
        <a href="<?php echo siteurl($siteid);?>" class="backHome">Homepage</a>
    </div>
</div>
